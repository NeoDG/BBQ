...
public class Part_6SaleActivity extends SherlockFragmentActivity /*implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ft.add(R.id.content, new Part_doublefargment_gen().genListFragment(6), "part-chat");
		ft.commit();
//
//		// 从资源文件在获取Tab的title
//		mTabTitles = new String[] { "出售", "求购" };
...
//		for (int i = 0; i < mTabTitles.length; i++) {
//			Fragment fragment = new Part_doublefargment_gen().genListFragment(6);
