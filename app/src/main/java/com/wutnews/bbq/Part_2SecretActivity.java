 ...
 *
 */
public class Part_2SecretActivity extends SherlockFragmentActivity{
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		ft.add(R.id.content, new Part_doublefargment_gen().genListFragment(2), "part-secret");
		ft.commit();
